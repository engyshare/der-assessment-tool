...
|  |  | 1 | `FR-402-AC2.E` | 동시에 성립할 수 없는 운전 — 운전 주체가 계통운영자인 급전 편익(FR-401-AC2.NWAs·FR-401-AC2.CP)과 운전 주체가 사업자인 편익(FR-4… | 자동 | test_phase1_dod.py, test_grid_support.py 2건, test_surplus_sale_charge_source_deduction.py, test_ess.py, test_exclusion.py 2건, test_grid_dispatch_benefits.py 4건, test_tou_arbitrage.py 5건 |
